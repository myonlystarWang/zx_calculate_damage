...
def render_video_page():
    ...
    st.page_link("https://www.bilibili.com/video/BV1Ez4y1g79W/?spm_id_from=333.337.search-card.all.click", label=f":blue[B站传送门]", icon=None, help=None, disabled=False, use_container_width=None)
    '''
    with st.expander("展开以查看视频"):   
        # 使用st.video函数播放视频
    ...
    st.page_link("https://www.bilibili.com/video/BV1MM411M7QY/?spm_id_from=333.337.search-card.all.click", label=f":blue[B站传送门]", icon=None, help=None, disabled=False, use_container_width=None)
    '''
    with st.expander("展开以查看视频"):   
        # 使用st.video函数播放视频
    ...
    st.page_link("https://www.bilibili.com/video/BV12j41167kP/?spm_id_from=333.337.search-card.all.click&vd_source=855eeacd96ef5d5a4aad6265c69ce3cd", label=f":blue[B站传送门]", icon=None, help=None, disabled=False, use_container_width=None)
    '''
    with st.expander("展开以查看视频"):   
        # 使用st.video函数播放视频
        #st.video("https://upos-sz-mirror08c.bilivideo.com/upgcxcode/67/47/1073454767/1073454767-1-208.mp4?e=ig8euxZM2rNcNbhMnwdVhwdlhzK3hwdVhoNvNC8BqJIzNbfq9rVEuxTEnE8L5F6VnEsSTx0vkX8fqJeYTj_lta53NCM=&uipk=5&nbs=1&deadline=1709187721&gen=playurlv2&os=08cbv&oi=2043500563&trid=40d6ed5deb8141918d83581f342022b8T&mid=531653450&platform=html5&upsig=605989c4f963abc8e0a16b563d7f62cb&uparams=e,uipk,nbs,deadline,gen,os,oi,trid,mid,platform&bvc=vod&nettype=0&bw=348623&orderid=0,1&buvid=&build=0&mobi_app=&f=T_0_0&logo=80000000")
