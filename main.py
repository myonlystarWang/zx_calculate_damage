...
var_gains_para_default = {'九华淀魂曲': '4级', "八级雷煌闪": '4级', "三味真炎火": '4级', "雪琪的祈愿": 50, '副本赠送属性': '空桑兽神', "龙虎之力": '龙虎3','三碗不过岗': 20, '墨雪特效霜情': 20000, '情愫项链技能佳期': 10, '法宝融合爆伤': 0, '进阶家族技能等级': 0.0, '经典家族技能等级': "15阶", "星语拔山": 20}

selected_roles_default = ["天音", "天华", "昭冥", "画影", "鬼王", "焚香", "青罗", "青云", "英招", "九黎", "百灵"]

selected_gains_default = ["九华淀魂曲", "八级雷煌闪", "三味真炎火", "雪琪的祈愿", "副本赠送属性", "龙虎之力", "墨雪特效霜情", "三碗不过岗", "情愫项链技能佳期", "法宝融合爆伤", "进阶家族技能等级", "经典家族技能等级", "星语拔山"]
